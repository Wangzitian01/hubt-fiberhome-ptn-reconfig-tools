...
public class Test03 {
	...
	public void Test003() throws IOException{
		List<BusinessList> BSL= RingRightTest(path);
		System.out.println("hahahahha:"+BSL.size());
		System.out.println(BSL);
		ReadExcel.writeListToExcel1(BSL, "C:\\Users\\13409\\Desktop\\环处理 - 副本.xls");
//		RingRightTest(path);//==>
//		RingLeftTest(path); //<==
	}
...
//			System.out.println("二次筛选后汇聚网元集合情况"+CList1);
			...
			//新增	========================
			BoardPort BP = BList.get(1);
		    Double boardId = (double) BP.getNewBoard();
		    String PortName = BP.getNewPortName();
			 		
			List<Integer> tunnelIdList = ChangeTunnelService.findTunnelId(tunnelList1);
			BusinessList BS = BusinessListServcie.AddClass(tunnelIdList, (int)NeId1, FConvergenceNeId2, boardId, PortName);
