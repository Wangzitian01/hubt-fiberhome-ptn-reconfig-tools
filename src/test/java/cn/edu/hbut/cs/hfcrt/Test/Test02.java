...
//			System.out.println("二次筛选后汇聚网元集合情况"+CList1);
			...
			System.out.println("第一条tunnel数据"+tunnelList1.get(1));
			Document Atunnel = tunnelList1.get(1);
			...
			System.out.println("未进行业务操作之前的tunnel中第一条tunnel为"+tunnelList1.get(1));
			...
			System.out.println("业务操作之后tunnel情况"+tunnelList1.get(1));
...
//			ReadExcel.writeListToExcel(map1,"C:\\Users\\13409\\Desktop\\烽火\\tunnel变化后结果.xls");
			...
			int _id = (int) tunnelList1.get(1).get("_id");
